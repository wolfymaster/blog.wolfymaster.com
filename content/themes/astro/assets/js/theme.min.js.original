...
$(document).ready(function(){function e(){if(""!==config.disqus_shortname){var e=config.disqus_shortname;!function(){var t=document.createElement("script");t.type="text/javascript",t.async=!0,t.src="//"+e+".disqus.com/embed.js",(document.getElementsByTagName("head")[0]||document.getElementsByTagName("body")[0]).appendChild(t)}()}else config.google_comments===!0&&$.getScript("https://apis.google.com/js/plusone.js").done(function(e,t){gapi.comments.render("g-comments",{href:window.location,width:"760",first_party_property:"BLOGGER",view_type:"FILTERED_POSTMOD"})})}if($("pre code").each(function(e){"undefined"!=typeof $(this).attr("data-language")&&$(this).attr("data-language")!==!1||$(this).attr("data-language","generic")}),config.highlightcode===!0&&Rainbow.color(),$("#cover").hasClass("featured")?$(".posts").waypoint(function(e){"down"===e&&($(".profile").addClass("stuck").removeClass("featured"),$(".flowbar").fadeIn(400)),"up"===e&&($(".profile").removeClass("stuck").addClass("featured"),$(".flowbar").fadeOut(400))}):$("#posttitle, .first").waypoint(function(e){"down"===e&&($(".profile").addClass("stuck"),$(".flowbar").fadeIn(400)),"up"===e&&($(".profile").removeClass("stuck"),$(".flowbar").fadeOut(400))}),$(".postprofile").waypoint(function(e){"down"===e&&$(".profile").addClass("hide"),"up"===e&&$(".profile").removeClass("hide")},{offset:"100%"}),0===$(".pagination .smallbutton").length&&$(".pagination").hide(),config.show_ecko_disclaimer===!1&&$(".copyright .ecko").hide(),$("#posttitle").length){var t=[];$(".postbody h2").waypoint(function(e){var o=$(this);"down"===e&&$(".flowbar h2").fadeOut(function(){t.push($(".flowbar h2").text()),$(this).text($(o).text()).fadeIn()}),"up"===e&&$(".flowbar h2").fadeOut(function(){$(this).text(t.pop()).fadeIn()})})}$(".postbody").fitVids(),(""!==config.disqus_shortname&&null!==config.disqus_shortname&&void 0!==config.disqus_shortname||config.google_comments===!0)&&($(".comments").show(),config.autoload_comments===!0&&(e(),$(".readmore").fadeOut(400))),$(".readmore").on("click",function(){e(),$(this).fadeOut(400)}),""!==config.analytics_id&&null!==config.analytics_id&&void 0!==config.analytics_id&&(!function(e,t,o,n,i,a,s){e.GoogleAnalyticsObject=i,e[i]=e[i]||function(){(e[i].q=e[i].q||[]).push(arguments)},e[i].l=1*new Date,a=t.createElement(o),s=t.getElementsByTagName(o)[0],a.async=1,a.src=n,s.parentNode.insertBefore(a,s)}(window,document,"script","//www.google-analytics.com/analytics.js","ga"),ga("create",config.analytics_id,"auto"),ga("send","pageview")),config.readingtime===!0&&$(".postbody").readingTime(),$(".movedown").on("click",function(){$("html, body").animate({scrollTop:$(".cover").height()},750)}),$(".footnote").on("click",function(){return $("html, body").animate({scrollTop:$($.attr(this,"href")).offset().top-100},500),!1}),$(".inlinemenu ul").hide(),$(".inlinemenu .graybar").on("click",function(){$(".inlinemenu ul").slideToggle()})});